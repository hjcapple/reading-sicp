...
(module* main #f
  ...
  (print-poly "p1" p1)
  (print-poly "p2" p2)
  (print-poly "gcd(p1, p2)" (greatest-common-divisor p1 p2))
  (print-poly "p1/gcd(p1, p2)" (div p1 (greatest-common-divisor p1 p2)))
  (print-poly "p2/gcd(p1, p2)" (div p2 (greatest-common-divisor p1 p2)))
)
